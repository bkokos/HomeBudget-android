...
public class FixedExpenses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expensesList = rootView.findViewById(R.id.fixedOutcomesLV);
        handler = new Handler() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ResponseEntity<List<Expense>> expenses = restTemplate
                        .exchange(Constans.hostName + "fixed-expense/get-all", HttpMethod.GET, null, new ParameterizedTypeReference<List<Expense>>() {});
